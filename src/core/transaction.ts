...
export async function beginTransaction({ client, clientMode }: ClientDetails): Promise<TransactionMode> {
  switch (clientMode) {
...
export function commitTransaction({ client, transactionMode }: TransactionDetails): Promise<unknown> {
...
export async function cancelTransaction({ client, transactionMode }: TransactionDetails): Promise<unknown> {
  switch (transactionMode) {
    case TransactionMode.Transaction:
